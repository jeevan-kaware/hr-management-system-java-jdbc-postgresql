...
The following screenshots demonstrate the application's functionality and database operations.
...
![View Employees](Screenshots/04-view-all-employees.png)
...
![Highest Salary](Screenshots/09-highest-salary.png)

---

## 🗄 PostgreSQL Database

![Database Tables](Screenshots/10-postgresql-database.png)

---

## 🧪 PostgreSQL Data

![Database Records](Screenshots/11-database-records.png)
